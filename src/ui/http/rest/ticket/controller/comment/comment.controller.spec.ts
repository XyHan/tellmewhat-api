...
import { CommentQueryRepository } from '../../../../../../infrastructure/ticket/repository/comment/comment.query-repository';
import { CommentCommandRepository } from '../../../../../../infrastructure/ticket/repository/comment/comment.command-repository';
...
describe('CommentController tests suite', () => {
  ...
  beforeAll(async () => {
    ...
    const moduleRef: TestingModule = await Test.createTestingModule({
      ...
      .useClass(LoggerMock)
      .overrideProvider(CommentQueryRepository)
  ...
  it('UPDATE - should return a CommentInterface', async () => {
    ...
    expect(response.body.content).toBe(`${CONTENT} Sed ac ultricies est. Donec egestas laoreet urna eget hendrerit.`);
  });
